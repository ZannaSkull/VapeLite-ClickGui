...
import at.thvf.volve.api.clickgui.values.ModeRender;
import at.thvf.volve.api.clickgui.values.NumberRender;
import at.thvf.volve.api.clickgui.values.OptionRender;
import at.thvf.volve.api.clickgui.values.ValueRender;
...
//        }
        ...
        Minecraft.getMinecraft().fontRendererObj.drawString(mod.getName(), (int) (x + 10), (int) (y + (mod.values.size() == 0 ? 10 : 8)), new Color(255, 255, 255).getRGB());
